...
void setup() {
  ...
  //ledDriver.setInterruptMask(AS1130::IMF_MovieFinished|AS1130::IMF_OverTemperature);
  //ledDriver.setInterruptFrame(5);
  //ledDriver.setInterfaceMonitoring(10, true);
  //ledDriver.setClockSynchronization(AS1130::SynchronizationOff, AS1130::Clock1MHz);
